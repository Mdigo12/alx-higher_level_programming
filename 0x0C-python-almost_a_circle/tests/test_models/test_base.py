...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_id_three_bases(self):
        """test id for three Base instances"""
        a = Base()
        b = Base()
        c = Base()
    ...
    def test_id_not_None(self):
        ...
        b = Base(5)
        c = Base()
        self.assertEqual(c.id, b.id - 3)

    def test_id_None(self):
        """test id with None as argument"""
        a = Base(None)
        b = Base(None)
        self.assertEqual(a.id, b.id - 1)

    def test_id_public(self):
        """test id is a public attr"""
        a = Base(8)
        a.id = 17
        self.assertEqual(a.id, 17)
...
class TestBase_to_json_string(unittest.TestCase):
    ...
    def test_to_json_string_rectangle_more_than_one_dict(self):
        r1 = Rectangle(10, 6, 5, 2, 1)
        r2 = Rectangle(4, 12, 9, 1, 2)
